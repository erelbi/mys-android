 ...
 */
  ...
  ((struct __pyx_vtabstruct_4kivy_8graphics_10tesselator_Tesselator *)__pyx_v_self->__pyx_vtab)->add_contour_data(__pyx_v_self, __pyx_v_cdata, ((int)(__pyx_t_12 / 2.)));
 ...
 * 
 */
  __pyx_tuple__25 = PyTuple_Pack(7, __pyx_n_s_Tesselator, __pyx_n_s_WINDING_ODD, __pyx_n_s_WINDING_NONZERO, __pyx_n_s_WINDING_POSITIVE, __pyx_n_s_WINDING_NEGATIVE, __pyx_n_s_TYPE_POLYGONS, __pyx_n_s_TYPE_BOUNDARY_CONTOURS); if (unlikely(!__pyx_tuple__25)) __PYX_ERR(0, 61, __pyx_L1_error)
 ...
 * 
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all, __pyx_tuple__25) < 0) __PYX_ERR(0, 61, __pyx_L1_error)
